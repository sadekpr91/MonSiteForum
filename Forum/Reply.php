<?php
    ...
    $result = mysqli_query($conn, "SELECT u1.nom, u2.nom, `comment`, `date`, idc FROM commente inner join utilisateur u1 on commente.idc=u1.id left join utilisateur u2 on commente.idr=u2.id where commente.id='$id'");
